...
public class RestaurantController {
  ...
  public ResponseEntity<GetRestaurantsResponse> getRestaurants(GetRestaurantsRequest getRestaurantsRequest) {  //return response entity
    ...
    if(latitude != null && longitude != null && latitude>=-90 && latitude<=90 && longitude>=-180 && longitude<=180)  
      ...
      return ResponseEntity.badRequest().body(getRestaurantsResponse); //response entity????
    }
  ...
  // @GetMapping(MENU_API)
  // public ResponseEntity<GetRestaurantsResponse> getMenu(Restaurant restaurant)
  // {
